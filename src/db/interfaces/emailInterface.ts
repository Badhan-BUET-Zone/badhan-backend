...
const CLIENT_ID = dotenv.dotenvEnvFile.GMAIL_CLIENT_ID
const CLIENT_SECRET = dotenv.dotenvEnvFile.GMAIL_CLIENT_SECRET
const REDIRECT_URI = dotenv.dotenvEnvFile.GMAIL_REDIRECT_URI
const REFRESH_TOKEN = dotenv.dotenvEnvFile.GMAIL_REFRESH_TOKEN
...
const generatePasswordForgotHTML = (token) => {
  const url = dotenv.dotenvEnvFile.VUE_APP_FRONTEND_BASE + '#/passwordReset?token=' + token
  return `
