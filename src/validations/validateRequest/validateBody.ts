...
export const validateBODYBloodGroup = body('bloodGroup')
...
export const validateBODYPublicContactBloodGroup = body('bloodGroup')
  .exists().withMessage('bloodGroup is required')
  .isInt().toInt().withMessage('bloodGroup must be integer')
  .isIn([-1, 0, 2, 4, 6]).withMessage('Please input valid blood group (-1,0,2,4,6)')

export const validateBODYHall = body('hall')
...
export const validateBODYStudentId = body('studentId')
  ...
  .custom(value => [0, 1, 2, 4, 5, 6, 8, 10, 11, 12, 15, 16, 18].includes(parseInt(value.substr(2, 2),10))).withMessage('Please input a valid department number')
  .custom(value => {
...
export const validateBODYComment = body('comment')
...
export const validateBODYDonationCount = body('extraDonationCount')
...
export const validateBODYRoomNumber = body('roomNumber')
...
export const validateBODYDonorId = body('donorId')
